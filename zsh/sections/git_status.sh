...
GIT_STATUS_UNTRACKED="${GIT_STATUS_UNTRACKED="%F{yellow}✭%F{black}"}"
GIT_STATUS_ADDED="${GIT_STATUS_ADDED="%F{green}✚%F{black}"}"
GIT_STATUS_MODIFIED="${GIT_STATUS_MODIFIED="%F{blue}✹%F{black}"}"
GIT_STATUS_RENAMED="${GIT_STATUS_RENAMED="»"}"
GIT_STATUS_DELETED="${GIT_STATUS_DELETED="%F{red}✘%F{black}"}"
